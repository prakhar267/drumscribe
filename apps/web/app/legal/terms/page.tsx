...
export default function TermsPage() {
  return <LegalPage title="Terms of use" updated="10 September 2026" intro="These draft terms explain the intended relationship between DrumToScore and its users. They are not final legal terms and require counsel review before public launch." sections={[
    { title: "The service", paragraphs: ["DrumToScore creates an editable first draft of a drum transcription from audio you provide. Generated results can be incomplete or inaccurate and must be reviewed before use."] },
