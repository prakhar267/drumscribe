...
export default function CopyrightPage() {
  return <LegalPage title="Copyright & upload policy" updated="10 September 2026" intro="DrumToScore is a private processing tool for audio the customer is entitled to use. It does not download from streaming platforms, host a public score catalogue or automatically publish generated charts." sections={[
