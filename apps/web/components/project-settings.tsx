  ...
  return (
    <div className="settings-layout">
      ...
      <div className="settings-content">
        ...
        <section className="surface settings-section" id="timing"><h2>Timing & notation</h2><p>Correct bar one, tempo, meter, beat markers and tempo changes in the dedicated Timing mode. Raw drum-hit timestamps stay intact.</p><div className="settings-form-grid"><label className="field"><span className="field-label">Tempo</span><input className="text-input" value={bpm === null ? "Loading…" : `${bpm} BPM`} readOnly /></label><label className="field"><span className="field-label">Time signature</span><input className="text-input" value={beatsPerMeasure === null ? "Loading…" : `${beatsPerMeasure}/4`} readOnly /></label></div><Link className="button button-small" href={`/projects/${projectId}?mode=timing`}>Open Timing mode</Link></section>
