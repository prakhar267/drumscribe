  ...
  return (
    <main className="practice-shell" id="main-content">
      ...
      <section className="practice-stage">
        ...
        <div className="practice-score"><NotationView project={project} events={events} selectedIds={new Set()} currentTime={transport.currentTime} onSeek={transport.seek} onSelect={(id) => { const event = events.find((item) => item.id === id); if (event) transport.seek(event.quantizedOnset); }} /></div>
