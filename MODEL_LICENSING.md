...
| DrumScribe `drumscribe-recall-fusion-v4` | This repository; config SHA-256 `8c0785c431740d84cdbabe2d973e50712d088d5085355e3cdd35f6ebdc4572f1` | Project code plus attributed ADTOF integration | Same hash-pinned v3 checkpoints; v4 adds no weights | First-party checkpoints use Groove/E-GMD and rights-cleared samples; four deterministic gate constants were selected during opened RWC development evaluation | **Yes for DrumScribe** under `OWNER-ATTESTATION-2026-09-05` | Preserve upstream attributions; keep the ADTOF grant/checkpoint private; RWC/MDB evaluation audio and annotations remain local and are not redistributed | Approved v3-compatible production decoder; 78.05% on the opened 100-song five-family benchmark and 80.61% on its separately held verification half; neither is a universal 90% claim |
| DrumScribe `drumscribe-recall-fusion-v5` | This repository; config SHA-256 `6e62bcc15b741d440209fd12fc4634fc723fdfade0bc816c5b7eb8bbf6f82e13` | Project code plus attributed ADTOF integration | Same hash-pinned v4 checkpoints; v5 adds no weights | First-party checkpoints use Groove/E-GMD and rights-cleared samples; deterministic fusion constants were selected during opened RWC development evaluation | **Yes for DrumScribe** under `OWNER-ATTESTATION-2026-09-05` | Preserve upstream attributions; keep the ADTOF grant/checkpoint private; RWC/MDB evaluation audio and annotations remain local and are not redistributed | Approved v4-compatible production decoder; 78.34% on the opened 100-song benchmark, 80.85% on its separate verification half, and 90.10% on MDB; these are benchmark-specific, not universal claims |
| DrumScribe `drumscribe-recall-fusion-v6` | This repository; config SHA-256 `c8bd5795cfc12b9acf170c8e7a2980f7e899d459733047ed65a77c0a6ecdc11d` | Project code plus attributed ADTOF integration | Same hash-pinned v5 checkpoints; v6 adds no weights | First-party checkpoints use Groove/E-GMD and rights-cleared samples; the adaptive tom rules were selected during opened RWC evaluation | **Yes for DrumScribe** under `OWNER-ATTESTATION-2026-09-05` | Preserve upstream attributions; keep the ADTOF grant/checkpoint private; RWC/MDB evaluation audio and annotations remain local and are not redistributed | Approved v5-compatible production decoder; 78.72% on the opened 100-song benchmark, 80.99% on its already-open secondary half, and 90.20% on MDB; these are benchmark-specific, not universal claims |
